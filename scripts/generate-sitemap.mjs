...
const pages = [
  ...
  { path: "/services/branding", changefreq: "quarterly", priority: "0.8" },
  { path: "/services/web", changefreq: "quarterly", priority: "0.8" },
  ...
  { path: "/process", changefreq: "quarterly", priority: "0.7" },
