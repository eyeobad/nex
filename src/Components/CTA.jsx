  ...
  return (
    <section id={id} ref={sectionRef} className="relative overflow-hidden bg-black text-white">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center gap-12 px-4 pb-20 pt-12 sm:px-10 md:flex-row md:items-center md:justify-center md:px-16 xl:px-[100px]">
        <div className="cta-card relative flex w-full max-w-[1240px] flex-col overflow-hidden rounded-[32px] bg-[#F3F3F3] px-6 py-10 text-black shadow-[0px_8px_0px_#191A23] sm:px-10 md:flex-row md:items-center md:justify-between md:gap-16 md:rounded-[45px] md:px-[60px] md:py-[70px]">
